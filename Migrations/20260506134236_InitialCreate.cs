    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "parkings",
                columns: new[] { "Id", "Location", "Name", "PricePerHour", "ReservedSpots", "TotalSpots" },
                values: new object[,]
                {
                    { 1, "Chalandri, Grammou 12", "Parking A", 2.50m, 0, 10 },
                    { 2, "Chalandri, Bakogianni 10", "Parking B", 2.00m, 0, 20 },
                    { 3, "Chalandri, Attikis 8", "Parking C", 1.50m, 0, 15 }
                });
